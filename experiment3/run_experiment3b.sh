...
declare -a B_T_MAX_vals=("50" "150" "250")
declare -a B_D_MAX_vals=($(seq 2 2 10))
...
do
    ...
    do
        ...
        sed -i "s/OUTPUT_CSV_FILE.*/OUTPUT_CSV_FILE \"results\/experiment3b-${B_T_MAX}-${B_D_MAX}.csv\"/" simparameters.h
